...
export default function PaymentCompletePage() {
  ...
  const { paymentSnapshot, paymentResult } = useCartStore();
    ...
    <div className='min-h-screen bg-white'>
      ...
      <div className='flex flex-col gap-5 items-center px-4 pt-[136px]'>
        ...
        <div className='flex flex-col gap-[60px] items-center w-full'>
          ...
          {/* Order Details */}
          <div className='bg-[#f9f9f9] rounded-[10px] p-5 w-full flex flex-col gap-4'>
            <div className='flex flex-col gap-[10px]'>
              {/* 매장명 */}
              <div className='grid grid-cols-[100px_1fr] gap-[10px] h-[19px]'>
                <p className='title1 text-[#4c4c4c]'>매장명</p>
                <p className='body3 text-[#262626] text-right'>{paymentSnapshot.storeName || '-'}</p>
              </div>
        ...
        <Button
          variant='outline'
          className='w-full h-11 border-[#c6c6c6] bg-white rounded-[6px] px-[12px] py-[10px]'
