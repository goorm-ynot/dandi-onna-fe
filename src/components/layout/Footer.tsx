...
export default function Footer() {
  return (
    <footer className='w-full bg-white border-t border-border-wrapper'>
      {/* ✅ 전체는 중앙 정렬 */}
      <div className='w-full px-16 max-[400px]:px-16 lg:px-[40px] pt-40 pb-20'>
        {/* ✅ 내부 컨테이너 */}
        <div className='max-w-[1280px] mx-auto flex flex-col gap-5'>
          ...
          <div className='flex flex-row justify-between items-start max-[400px]:flex-col max-[400px]:items-left max-[400px]:gap-20'>
            {/* 왼쪽 */}
            <div className='flex flex-col min-[400px]:flex-row items-start min-[400px]:items-center gap-[20px]'>
              <div className=' title7 max-[400px]:title5'>단디온나</div>

              <div className='flex flex-wrap items-center gap-[20px] max-[400px]:gap-3 text-xs text-neutral-900'>
            ...
            {/* 오른쪽 */}
            <div className='flex flex-col min-[400px]:flex-row min-[400px]:items-center min-[400px]:gap-2 text-right min-[400px]:text-left gap-[10px]'>
